...
async function getStaticProps() {
  ...
  const client = await external_mongodb_["MongoClient"].connect("mongodb+srv://admin-suraj:admin123@cluster0.k3iv1an.mongodb.net/meetups?retryWrites=true&w=majority");
  const db = client.db();
